...
Route::get('/ajout_jeu/{game_id}', [CollectionGameController::class, 'add_to_collection']);
Route::get('/ajout_support/{support_id}', [CollectionSupportController::class, 'add_to_collection']);
...
Route::get('/liste_utilisateurs_admin', [UserController::class, 'liste_utilisateurs_admin']);
Route::get('/delete_utilisateur/{id}', [UserController::class, 'delete_utilisateur']);
Route::get('/delete_collection_jeu/{game_id}', [CollectionGameController::class, 'delete_collection_jeu']);
Route::get('/delete_collection_support/{support_id}', [CollectionSupportController::class, 'delete_collection_support']);
...
Route::get('/change_visibilite/{id}', [UserController::class, 'change_visibilite']);
